...
In order to successfully build and run the project, you must have also downloaded the corresponding core repository from [here](https://github.com/eu-digital-green-certificates/dgca-app-core-android) and also the DGC-SDK - test package available [here](https://github.com/VC19tests/VC19-SDK-Test). All projects should be at the same folder level as eachother which would look something like
